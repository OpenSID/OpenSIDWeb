define({ "api": [
  ...
  },
  {
    "type": "get",
    "url": "/mandiri/pribadi",
    "title": "mendapatkan data pribadi penduduk untuk layanan mandiri",
    "name": "GetMandiri",
    "group": "Layanan_Mandiri",
    "header": {
      "fields": {
        "Header": [
          {
            ...
            "optional": false,
            "field": "Authorization",
            "description": "<p>Token yang didapatkan dari menu auth/tokenMandiri.</p>"
          }
        ]
      }
    },
        ...
        "Error 4xx": [
          {
            ...
            "optional": false,
            "field": "Unauthorized",
            "description": "<p>token tidak valid</p>"
          }
        ]
      },
      "examples": [
    ...
    "version": "0.0.0",
    "filename": "application/controllers/api/Mandiri.php",
    "groupTitle": "Layanan_Mandiri"
  },
  {
    "type": "get",
